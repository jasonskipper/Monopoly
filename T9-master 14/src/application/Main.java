...
//		}
	...
	public void beginGame(String[] args) {
		launch(args);
	}
	...
	public static void monopolyBoard(Stage primaryStage, GameFacade facade) {
		...
		setXY(942, 560, hotelBoardWalkText);
	      ...
	      int current=0;
	      while(current<facade.getPlayerList().size()) {
	    	  if(current == 0) {
	    		  root.getChildren().add(playerOneMoney);
	    		  if(facade.getPlayerList().get(current).getShape().equals("square")) {
	    			  facade.getPlayerList().get(current).setPlayerImage(new ImageView(square));
	    			  System.out.println(facade.getPlayerList().get(0).getShape().equals("square"));
	    			  root.getChildren().add(squareView);
	    			  squareView.setX(70); 
	    			  squareView.setY(130); 
	    		  }else if(facade.getPlayerList().get(current).getShape().equals("diamond")){
	    			  facade.getPlayerList().get(current).setPlayerImage(new ImageView(diamond));
	    			  root.getChildren().add(diamondView);
	    			  diamondView.setX(70); 
	    			  diamondView.setY(130); 
	    		  }else if(facade.getPlayerList().get(current).getShape().equals("triangle")){
	    			  facade.getPlayerList().get(current).setPlayerImage(new ImageView(triangle));
	    			  root.getChildren().add(triangleView);
	    			  triangleView.setX(70); 
	    			  triangleView.setY(130); 
	    		  }else if(facade.getPlayerList().get(current).getShape().equals("circle")){
	    			  facade.getPlayerList().get(current).setPlayerImage(new ImageView(circle));
...
//	      ImageView playerCircleView = new ImageView(circle); 
	      ...
	      while(counter<facade.getPlayerList().size()) {
	    	  shapePlayers.add(facade.getPlayerList().get(counter).getShape());
	    	  counter++;
	      }
	      
			if(shapePlayers.contains("circle")) {
				root.getChildren().add(facade.getPlayerList().get(shapePlayers.indexOf("circle")).getPlayerImage());
				
				facade.getPlayerList().get(shapePlayers.indexOf("circle")).getPlayerImage().setX(895); 
				facade.getPlayerList().get(shapePlayers.indexOf("circle")).getPlayerImage().setY(700); 
				facade.getPlayerList().get(shapePlayers.indexOf("circle")).getPlayerImage().setFitHeight(15); 
				facade.getPlayerList().get(shapePlayers.indexOf("circle")).getPlayerImage().setFitWidth(15); 
				//root.getChildren().add(squareView);
			} 
			if(shapePlayers.contains("triangle")) {
				root.getChildren().add(facade.getPlayerList().get(shapePlayers.indexOf("triangle")).getPlayerImage());
				facade.getPlayerList().get(shapePlayers.indexOf("triangle")).getPlayerImage().setX(760); 
				facade.getPlayerList().get(shapePlayers.indexOf("triangle")).getPlayerImage().setY(700); 
				facade.getPlayerList().get(shapePlayers.indexOf("triangle")).getPlayerImage().setFitHeight(15); 
				facade.getPlayerList().get(shapePlayers.indexOf("triangle")).getPlayerImage().setFitWidth(15); 
				//root.getChildren().add(triangleView);
			}
			if(shapePlayers.contains("square")) {
				root.getChildren().add(facade.getPlayerList().get(shapePlayers.indexOf("square")).getPlayerImage());
				facade.getPlayerList().get(shapePlayers.indexOf("square")).getPlayerImage().setX(895);
				facade.getPlayerList().get(shapePlayers.indexOf("square")).getPlayerImage().setY(600); 
				facade.getPlayerList().get(shapePlayers.indexOf("square")).getPlayerImage().setFitHeight(15); 
				facade.getPlayerList().get(shapePlayers.indexOf("square")).getPlayerImage().setFitWidth(15); 
				 //root.getChildren().add(squareView);
			}
			if(shapePlayers.contains("diamond")) {
				root.getChildren().add(facade.getPlayerList().get(shapePlayers.indexOf("diamond")).getPlayerImage());
				facade.getPlayerList().get(shapePlayers.indexOf("diamond")).getPlayerImage().setX(760); 
				facade.getPlayerList().get(shapePlayers.indexOf("diamond")).getPlayerImage().setY(600); 
				facade.getPlayerList().get(shapePlayers.indexOf("diamond")).getPlayerImage().setFitHeight(15); 
				facade.getPlayerList().get(shapePlayers.indexOf("diamond")).getPlayerImage().setFitWidth(15); 
				//root.getChildren().add(diamondView);
			}
...
//						  stage.show();
			...
			turns(0, facade, diceRoll, root, facade.getBoard(), playerOneMoney, playerTwoMoney, playerThreeMoney, playerFourMoney, houseHotelText);
	...
	public static void turns(int currentPlayer, GameFacade facade, Button diceRoll, Group root, Board board, Text one, Text two, Text three, Text four, ArrayList<Text> houseHotelText) {
		...
		if(secondsPassed==300) {
			...
			for(int i = 0; i<facade.getPlayerList().size();i++) {
				if(facade.getPlayerList().get(i).getNetWorth()>currentHigh) {
					currentHigh=facade.getPlayerList().get(i).getNetWorth();
					for(int j=0; j<winTie.size();j++) {
						winTie.remove(j);
					}
					winTie.add(facade.getPlayerList().get(i));
				}else if(facade.getPlayerList().get(i).getNetWorth()==currentHigh) {
					winTie.add(facade.getPlayerList().get(i));
				}
			}
			 Text endText = new Text();
			if(winTie.size()<=1) {
				endText.setText("Game has finished!\n Player "+String.valueOf(facade.getPlayerList().indexOf(winTie.get(0))+1)+" HAS WON!");
			}else {
				String allPlayersWin ="";
				for(int i =0; i<winTie.size();i++) {
					allPlayersWin += " "+String.valueOf(facade.getPlayerList().indexOf(winTie.get(i))+1);
				}
		...
		if(currPlayer[0] == facade.getPlayerList().size()) {
			currPlayer[0]= 0;
			currentPlayer=0;
		}
        ...
        Group turnBox = new Group();
		 diceRoll.setOnAction(e->{
			  ...
			  facade.getDiceOne().roll();
			  facade.getDiceTwo().roll();
			  Label moved=new Label("Player has a rolled a " + facade.getDiceOne().getNumber() + " and " + facade.getDiceTwo().getNumber() + " = " + String.valueOf(facade.getDiceOne().getNumber()+facade.getDiceTwo().getNumber()));
	          
			 if(facade.getPlayerList().get(currPlayer[0]).getIsInJail()) {
				 facade.getPlayerList().get(currPlayer[0]).setJailTurns(facade.getPlayerList().get(currPlayer[0]).getJailTurns()-1);
				 if(facade.getPlayerList().get(currPlayer[0]).getJailTurns() == 0) {
					 facade.getPlayerList().get(currPlayer[0]).setIsInJail(false);
				 }
				 currPlayer[0]++;
				 turns(currPlayer[0], facade, diceRoll, root, board, one, two, three, four, houseHotelText);
				 return;
	          ...
	          int temp = facade.getPlayerList().get(currPlayer[0]).getBoxLocation() + facade.getDiceOne().getNumber()+facade.getDiceTwo().getNumber();
	          facade.getPlayerList().get(currPlayer[0]).setBoxLocation(temp);
	          
	          //CHANGE X AND Y OF PLAYER ON BOARD
	          movePlayer(facade.getPlayerList().get(currPlayer[0]));
	          
	          Label numPlayers=new Label("Player "+ String.valueOf(currPlayer[0]+1) +" landed on:"+ board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0])));
	          
			  if(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))) != null) { //Is it a property at box location?
				  if(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).ownedByPlayer()) {
					  //PAY RENT
					  
					  if(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).getPlayer() == facade.getPlayerList().get(currPlayer[0])) {
						  //CURRENT PLAYER OWNS THE PROPERTY!

						  if(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).getHotelNum()!=1) {
							  if(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).getHouseNum()<4) {
								  ...
								  addHouse.setOnAction(ee->{
									  Property propertyHere= board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0])));
...
//						 
					  ...
					  Player tempPlayer = board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).chargeRent(facade.getPlayerList().get(currPlayer[0]));
					  int tempIntPlayer = facade.getPlayerList().indexOf(tempPlayer);
					  
					  if(currPlayer[0]==0 ){
						  one.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
					  }else if(currPlayer[0]==1) {
						  two.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
					  }else if(currPlayer[0]==2) {
						  three.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
					  }else if(currPlayer[0]==3) {
						  four.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
					  }
					  
					  if(tempIntPlayer==0 ){
						  one.setText(String.valueOf(facade.getPlayerList().get(tempIntPlayer).getMoney()));
					  }else if(tempIntPlayer==1) {
						  two.setText(String.valueOf(facade.getPlayerList().get(tempIntPlayer).getMoney()));
					  }else if(tempIntPlayer==2) {
						  three.setText(String.valueOf(facade.getPlayerList().get(tempIntPlayer).getMoney()));
					  }else if(tempIntPlayer==3) {
						  four.setText(String.valueOf(facade.getPlayerList().get(tempIntPlayer).getMoney()));
					  }
					  ...
					  buy.setOnAction(a->{
						  ...
						  stage.hide();
						  board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).purchase(facade.getPlayerList().get(currPlayer[0]));
						  facade.getPlayerList().get(currPlayer[0]).addProperty(board.indexOfProperty(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(), facade.getPlayerList().get(currPlayer[0]))));
						  if(currPlayer[0]==0) {
							  one.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
						  }else if(currPlayer[0]==1) {
							  two.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
			  ...
			  }else if(board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))) != null){ //Is it a utility at box location?
				  if(board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).ownedByPlayer()) {
					  //PAY RENT
					  int mult = board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).getPlayer().getUtility();
					  Player tempPlayer = board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).chargeRent(facade.getPlayerList().get(currPlayer[0]), facade.getDiceOne().getNumber() + facade.getDiceTwo().getNumber(), mult);	
					  ...
					  buy.setOnAction(a->{
						  System.out.println("BOUGHT");
						  stage.hide();
						  board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).purchase(facade.getPlayerList().get(currPlayer[0]));
						  facade.getPlayerList().get(currPlayer[0]).addUtility(board.indexOfUtility(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(), facade.getPlayerList().get(currPlayer[0]))));
						  if(currPlayer[0]==0) {
							  one.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
						  }else if(currPlayer[0]==1) {
							  two.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
			  ...
			  else if(board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))) != null) { //is it a railroad at this box location
				  if(board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).ownedByPlayer()) {
					  //PAY RENT
					  int mult = board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0]))).getPlayer().getRailroad();
					  Player tempPlayer = board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(), facade.getPlayerList().get(currPlayer[0]))).chargeRent(facade.getPlayerList().get(currPlayer[0]), mult);
					  ...
					  buy.setOnAction(a->{
						  System.out.println("BOUGHT");
						  stage.hide();
						  board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(), facade.getPlayerList().get(currPlayer[0]))).purchase(facade.getPlayerList().get(currPlayer[0]));
						  facade.getPlayerList().get(currPlayer[0]).addRailroad(board.indexOfRailroad(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(), facade.getPlayerList().get(currPlayer[0]))));
						  if(currPlayer[0]==0) {
							  one.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
						  }else if(currPlayer[0]==1) {
							  two.setText(String.valueOf(facade.getPlayerList().get(currPlayer[0]).getMoney()));
		      ...
		      }else if(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0])).equals("Income Tax")) {
				  ...
				  tenPercent.setOnAction(a->{
					  stage.hide();
					int netWorth = facade.getPlayerList().get(currPlayer[0]).getNetWorth();
					facade.getPlayerList().get(currPlayer[0]).setMoney(facade.getPlayerList().get(currPlayer[0]).getMoney() + ((int)(netWorth * .1)));
					  currPlayer[0]++;
					turns(currPlayer[0], facade, diceRoll, root, board, one, two, three, four, houseHotelText);
				  });
				  twoHundred.setOnAction(a->{
					  stage.hide();
					  currPlayer[0]++;
					  facade.getPlayerList().get(currPlayer[0]).setMoney(facade.getPlayerList().get(currPlayer[0]).getMoney() - 200);
					turns(currPlayer[0], facade, diceRoll, root, board, one, two, three, four, houseHotelText);
				  });
				  
		      }else if(board.whatsInBox(facade.getPlayerList().get(currPlayer[0]).getBoxLocation(),facade.getPlayerList().get(currPlayer[0])).equals("GO TO JAIL")) {
				  Player playerHere =  facade.getPlayerList().get(currPlayer[0]);
...
//	}
	...
	public static void playerNumPopUp(Stage primaryStage) {
          ...
          b.setOnAction(e->{
        	  stage.hide();
        	  if(Integer.parseInt(tf1.getText())<=4 && Integer.parseInt(tf1.getText())>=2) {
        		  playerSelect(Integer.parseInt(tf1.getText()),numArray,primaryStage, gameFacade);
        	  }else {
        		  playerNumPopUp(primaryStage);
        	  }
	...
	public static void playerSelect(int playersNum, int[] current, Stage primaryStage, GameFacade facade) {
		
		 if(playersNum<current[0]) {
			 monopolyBoard(primaryStage, facade);
			 return;
		 }
		 Stage stage = new Stage();
         ...
         circle.setOnAction(e->{
	        //players.add("circle");
		 boolean taken = false;
		 for(int c = 0; c < facade.getPlayerList().size(); c++){
			 if(facade.getPlayer(c).getShape().equals("circle")){
				 taken = true;
			 } 
		 }
		if(taken){
			System.out.println("Token already selected, pick again");
			stage.hide();
			playerSelect(playersNum, current,primaryStage, facade);
		}
		else{
			facade.createPlayer("circle");
	        	stage.hide();
	        	current[0]++;
	        	playerSelect(playersNum, current,primaryStage, facade);
		}
         ...
         triangle.setOnAction(e->{
        	...
        	boolean taken = false;
		 for(int c = 0; c < facade.getPlayerList().size(); c++){
			 if(facade.getPlayer(c).getShape().equals("triangle")){
				 taken = true;
			 } 
		 }
		if(taken){
         ...
         square.setOnAction(e->{
        	...
        	boolean taken = false;
		 for(int c = 0; c < facade.getPlayerList().size(); c++){
			 if(facade.getPlayer(c).getShape().equals("square")){
				 taken = true;
			 } 
		 }
		if(taken){
         ...
         diamond.setOnAction(e->{
        	...
        	boolean taken = false;
		 for(int c = 0; c < facade.getPlayerList().size(); c++){
			 if(facade.getPlayer(c).getShape().equals("diamond")){
				 taken = true;
			 } 
		 }
		if(taken){
