...
public class Board {
    ...
    Property indexOfProperty(String propertyName) {
    ...
    Utility indexOfUtility(String utilityName) {
    ...
    ArrayList<Railroad> getRailroadList(){
    	return listOfRailroads;
    }
    
    
    
    Railroad indexOfRailroad(String railroadName) {
    ...
    ArrayList<Utility> getUtilityList(){
    	return listOfUtilities;
    }
    
    
    
    String whatsInBox(int boxLocation, Player player) {
    	if(boxLocation == 0) {
